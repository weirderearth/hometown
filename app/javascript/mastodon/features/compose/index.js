...
class Compose extends React.PureComponent {
  ...
  render () {
    ...
    if (multiColumn) {
      const defaultTabIds = enable_limited_timeline ? ['START', 'HOME', 'LIMITED', 'NOTIFICATIONS', 'COMMUNITY', 'PUBLIC', 'PREFERENCES', 'SIGN_OUT'] : ['START', 'HOME', 'NOTIFICATIONS', 'COMMUNITY', 'PUBLIC', 'PREFERENCES', 'SIGN_OUT'];
